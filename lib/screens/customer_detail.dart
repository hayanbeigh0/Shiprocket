...
import '../provider/added_customer.dart';
...
class CustomerDetailScreen extends StatefulWidget {
  const CustomerDetailScreen({required this.index, Key? key}) : super(key: key);
  final int index;
...
class _CustomerDetailScreenState extends State<CustomerDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            customerInfo(context, customerDetail),
            Padding(
              ...
              child: Padding(
                ...
                child: ListView.builder(
                  ...
                  itemCount: customerDetail
                      .addedCustomers[widget.index].addressList.length,
                  itemBuilder: (context, index) {
                    return Padding(
                      padding: const EdgeInsets.symmetric(vertical: 5.0),
                      child: CustomerDeliveryAddress(
  ...
  SizedBox customerInfo(
      BuildContext context, AddedCustomerProvider customerDetail) {
    return SizedBox(
      height: 380,
      child: Stack(
        children: [
                ...
                children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                customerDetail
                                    .addedCustomers[widget.index].phoneNumber,
                                style: TextStyle(
                                  color: ColorStyle.colorPrimary,
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600,
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                customerDetail.addedCustomers[widget.index]
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        firstNameController.text = customerDetail
                            .addedCustomers[widget.index].firstName;
                        lastNameController.text = customerDetail
                            .addedCustomers[widget.index].lastName;
                        emailController.text =
                            customerDetail.addedCustomers[widget.index].email;
                        phoneNumberController.text = customerDetail
                            .addedCustomers[widget.index].phoneNumber;
                        showDialog(
                          context: context,
...
class CustomerDeliveryAddress extends StatelessWidget {
  ...
  final AddedCustomerProvider customerDetail;
  final widget;
  final int index;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '${customerDetail.addedCustomers[widget.index].addressList[index].houseNumber}, ${customerDetail.addedCustomers[widget.index].addressList[index].streetName}, ${customerDetail.addedCustomers[widget.index].addressList[index].city}, ${customerDetail.addedCustomers[widget.index].addressList[index].state} - ${customerDetail.addedCustomers[widget.index].addressList[index].pincode}',
              style: const TextStyle(
                fontSize: 15,
